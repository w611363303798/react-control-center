      ...
      function (_TargetClass) {
        ...
        function CcClass(props, context) {
          ...
          try {
            ...
            var ccClassContext = ccClassKey_ccClassContext_[ccClassKey];
            helper.setRef((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), isSingle, ccClassKey, newCcKey, ccUniqueKey, ccOption);
        ...
        _proto.__$$mapCcToInstance = function __$$mapCcToInstance(isSingle, asyncLifecycleHook, ccClassKey, ccKey, ccUniqueKey, isCcUniqueKeyAutoGenerated, storedStateKeys, ccOption, ccClassContext, currentModule, currentReducerModule, sharedStateKeys, globalStateKeys) {
          ...
          this.cc = (_this$cc = {
            ...
            __xeffect: function __xeffect(targetModule, userLogicFn, extra, lazyMs) {
              ...
              var dispatch = _this2.__$$getDispatchHandler(_constant.STATE_FOR_ONE_CC_INSTANCE_FIRSTLY, currentModule, currentReducerModule, null, null, -1, ccKey);
