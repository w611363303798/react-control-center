      ...
      function (_TargetClass) {
        ...
        function CcClass(props, context) {
          ...
          try {
            ...
            _util.default.bindThis((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), ['__$$mapCcToInstance', '$$changeState', '__$$recoverState', '$$domDispatch', '__$$getChangeStateHandler', '__$$getEffectHandler', '__$$getLazyEffectHandler', '__$$getXEffectHandler', '__$$getLazyXEffectHandler', '__$$getDispatchHandler']);
        ...
        _proto.__$$mapCcToInstance = function __$$mapCcToInstance(isSingle, asyncLifecycleHook, ccClassKey, ccKey, ccUniqueKey, isCcUniqueKeyAutoGenerated, storedStateKeys, ccOption, ccClassContext, currentModule, currentReducerModule, sharedStateKeys, globalStateKeys) {
          ...
          this.cc = (_this$cc = {
            ...
            __invokeWith: function __invokeWith(userLogicFn, executionContext) {
              ...
              isStateModuleValid(targetModule, currentModule, cb, function (err, newCb) {
                ...
                if (context) {
                  var executionContextForUser = (0, _extends2.default)({}, executionContext, {
            ...
            if (ccClassKeys) {
              ...
              ccClassKeys.forEach(function (ccClassKey) {
                ...
                var _extractStateByKeys7 = (0, _extractStateByKeys11.default)(_partialSharedState, sharedStateKeys),
                ...
                var _extractStateByKeys8 = (0, _extractStateByKeys11.default)(partialGlobalState, globalStateKeys),
                ...
                ccKeys.forEach(function (ccKey) {
                  ...
                  if (ref) {
                    ...
                    if (toSet) {
                      ...
                      ref.cc.prepareReactSetState(changedBy, toSet, _constant.STATE_FOR_ONE_CC_INSTANCE_FIRSTLY);
                    }
                  ...
                  ccKeys.forEach(function (ccKey) {
                    ...
                    if (ref) {
                      ...
                      if (option.syncGlobalState) {
                        ...
                        ref.cc.prepareReactSetState(_constant.CHANGE_BY_BROADCASTED_GLOBAL_STATE_FROM_OTHER_MODULE, globalStateForCurrentCcClass, _constant.STATE_FOR_ONE_CC_INSTANCE_FIRSTLY);
                      }
                    }
                  });
                });
                ...
                ccKeys.forEach(function (ccKey) {
                  ...
                  if (ref) {
                    ...
                    if (option.syncGlobalState === true) {
                      ref.cc.prepareReactSetState(_constant.CHANGE_BY_BROADCASTED_GLOBAL_STATE, partialState, _constant.STATE_FOR_ONE_CC_INSTANCE_FIRSTLY);
                    }
                  }
                });
              }
          ...
          this.$$dispatch = this.__$$getDispatchHandler(_constant.STATE_FOR_ONE_CC_INSTANCE_FIRSTLY, currentModule, null, null, null, -1, ccKey);
          ...
          var _doChangeState = function _doChangeState() {
            if (module == _constant.MODULE_GLOBAL) {
              ...
              if (module === currentModule) {
                ...
                _this3.cc.prepareReactSetState(changedBy || _constant.CHANGE_BY_SELF, state, stateFor, function () {
        ...
        _proto.$$domDispatch = function $$domDispatch(event) {
          ...
          var handler = this.__$$getDispatchHandler(_constant.STATE_FOR_ONE_CC_INSTANCE_FIRSTLY, module, reducerModule, type, payload, cclazyms, ccKey);
