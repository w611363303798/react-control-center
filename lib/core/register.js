...
function register(ccClassKey, _temp) {
  ...
  if (contextMap[ccClassKey] !== undefined) {
    ...
    contextMap[ccClassKey] = _util.default.makeCcClassContext(_curStateModule, sharedStateKeys, globalStateKeys);
  }
  ...
  return function (ReactClass) {
    ...
    function (_ReactClass) {
      ...
      function CcClass(props, context) {
        ...
        _util.default.bindThis((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), ['__$$bindDataToCcClassContext', '__$$mapCcToInstance', '__$$getChangeStateHandler', '$$changeState', '__$$recoverState']);
      ...
      _proto.$$changeState = function $$changeState(state, _temp7) {
        ...
        if (module === currentModule) {
          ...
          this.cc.prepareReactSetState(changeWay || _constant.CHANGE_BY_SELF, state, isStateGlobal, function () {
