  ...
  return function (ReactClass) {
    ...
    function (_ReactClass) {
      ...
      function CcClass(props, context) {
        ...
        _util.default.bindThis((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), ['__$$bindDataToCcClassContext', '__$$mapCcToInstance', '$$getChangeStateHandler', '$$changeState']);
      ...
      _proto.componentDidMount = function componentDidMount() {
        ...
        var selfState = _ccContext.default.refStore._state[ccUniqueKey];
        ...
        var sharedState = _ccContext.default.store._state[module];
        var globalState = _ccContext.default.store._state[_constant.MODULE_GLOBAL];
        ...
        function mergeSharedStateToSelfState() {
          if (!isSharedStateEmpty && isSelfStateEmpty) {
            changeWay = _constant.SYNC_FROM_CC_CLASS_STORE;
            toSet = newSharedState;
          } else if (isSharedStateEmpty && !isSelfStateEmpty) {
            changeWay = _constant.SYNC_FROM_CC_REF_STORE;
            toSet = newSelfState;
          } else if (!isSharedStateEmpty && !isSelfStateEmpty) {
            changeWay = _constant.SYNC_FROM_CC_CLASS_STORE_AND_REF_STORE;
            toSet = (0, _extends2.default)({}, newSharedState, newSelfState);
          }
        }

        function mergeGlobalStateAndSharedStateToSelfState() {
          if (!isGlobalStateEmpty && !isSharedStateEmpty && !isSelfStateEmpty) {
            changeWay = _constant.SYNC_FROM_GLOBAL_STORE_AND_CC_CLASS_STORE_AND_REF_STORE;
            toSet = (0, _extends2.default)({}, newGlobalState, newSharedState, newSelfState);
          } else if (!isGlobalStateEmpty && !isSharedStateEmpty && isSelfStateEmpty) {
            changeWay = _constant.SYNC_FROM_GLOBAL_STORE_AND_CC_CLASS_STORE;
            toSet = (0, _extends2.default)({}, newGlobalState, newSharedState);
          } else if (!isGlobalStateEmpty && isSharedStateEmpty && !isSelfStateEmpty) {
            changeWay = _constant.SYNC_FROM_GLOBAL_STORE_AND_REF_STORE;
            toSet = (0, _extends2.default)({}, newGlobalState, newSelfState);
          } else if (!isGlobalStateEmpty && isSharedStateEmpty && isSelfStateEmpty) {
            changeWay = _constant.SYNC_FROM_GLOBAL_STORE;
        ...
        this.cc = {
          ...
          prepareReactSetState: function prepareReactSetState(changeWay, state, next, reactCallback) {
            if (storedStateKeys.length > 0) {
              ...
              if (!isStateEmpty) {
                _ccContext.default.refStore._state[ccUniqueKey] = partialState;
              }
            }
            ...
            if (globalStateKeys.length > 0) {
              ...
              if (!isPartialGlobalStateEmpty) _ccContext.default.store.setGlobalState(_partialState);
            }
          ...
          broadcastState: function broadcastState(moduleName, sourceSharedState, needClone, excludeTriggerRef) {
            ...
            if (needClone) _sourceSharedState = _util.default.clone(sourceSharedState); // this clone may cause performance issue, if sourceSharedState is too big!!

            _ccContext.default.store.setState(module, _sourceSharedState);
            ...
            ccClassKeys.forEach(function (classKey) {
              ...
              if (isSharedStateEmpty && !isPartialGlobalStateEmpty) {
                ...
                mergedStateForCurrentCcClass = (0, _extends2.default)({}, globalStateForCurrentCcClass, sharedStateForCurrentCcClass);
              }
