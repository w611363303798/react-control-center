...
function mapCcClassKeyAndCcClassContext(ccClassKey, moduleName, originalSharedStateKeys, originalGlobalStateKeys, sharedStateKeys, globalStateKeys, stateToPropMapping, isPropStateModuleMode) {
  ...
  var ccClassContext = _util.default.makeCcClassContext(moduleName, sharedStateKeys, globalStateKeys, originalSharedStateKeys, originalGlobalStateKeys);
...
function mapModuleAndCcClassKeys(moduleName, ccClassKey) {
  ...
  if (ccClassKeys.includes(ccClassKey)) {
    throwCcHmrError(_constant.ERR.CC_CLASS_KEY_DUPLICATE, "ccClassKey:" + ccClassKey + " duplicate");
  }
...
function bindEventHandlerToCcContext(module, ccClassKey, ccUniqueKey, event, identity, handler) {
  ...
  var handlerKey = (0, _util.makeHandlerKey)(ccUniqueKey, event); //  that means the component of ccUniqueKey mounted again 
...
function _promisifyCcFn(ccFn, userLogicFn, executionContext) {
  ...
  return new Promise(function (resolve, reject) {
    var _executionContext = (0, _extends2.default)({}, executionContext, {
      ...
      function (_TargetClass) {
        ...
        function CcClass(props, context) {
          ...
          try {
            ...
            _util.default.bindThis((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), ['__$$bindDataToCcClassContext', '__$$mapCcToInstance', '__$$getChangeStateHandler', '$$changeState', '__$$recoverState', '__$$getDispatchHandler', '$$domDispatch']);
        ...
        _proto.__$$recoverState = function __$$recoverState() {
          ...
          var entireState = (0, _extends2.default)({}, selfState, refState, partialSharedState, partialGlobalState);
        ...
        _proto.__$$mapCcToInstance = function __$$mapCcToInstance(isSingle, asyncLifecycleHook, ccClassKey, ccKey, ccUniqueKey, isCcUniqueKeyAutoGenerated, storedStateKeys, ccOption, ccClassContext, currentModule, currentReducerModule, sharedStateKeys, globalStateKeys) {
          ...
          this.cc = (_this$cc = {
            ...
            _xeffect: function _xeffect(targetModule, userLogicFn, lazyMs) {
              var dispatch = _this2.__$$getDispatchHandler(_constant.STATE_FOR_ONE_CC_INSTANCE_FIRSTLY, currentModule, currentReducerModule);
            ...
            var contextDispatch = _this2.__$$getDispatchHandler(_constant.STATE_FOR_ALL_CC_INSTANCES_OF_ONE_MODULE, targetStateModule, targetReducerModule, null, null, lazyMs);
            ...
            if (storedStateKeys.length > 0) {
              ...
              if (!isStateEmpty) {
                if (ccOption.storeInLocalStorage === true) {
                  ...
                  var currentStoredState = (0, _extends2.default)({}, entireStoredState, partialState);
            ...
            if (!isPartialGlobalStateEmpty) ccStoreSetState(_constant.MODULE_GLOBAL, partialGlobalState); // ??? here logic code is redundant, in extractStateToBeBroadcasted, 
          ...
          this.$$dispatch = this.__$$getDispatchHandler(_constant.STATE_FOR_ONE_CC_INSTANCE_FIRSTLY, currentModule);
          this.$$dispatchForModule = this.__$$getDispatchHandler(_constant.STATE_FOR_ALL_CC_INSTANCES_OF_ONE_MODULE, currentModule);
          ...
          var _doChangeState = function _doChangeState() {
            if (module == _constant.MODULE_GLOBAL) {
              ...
              if (module === currentModule) {
                ...
                _this3.cc.prepareReactSetState(changedBy || _constant.CHANGE_BY_SELF, state, function () {
                  //if forceSync=true, cc clone the input state
                  if (forceSync === true) {
                    _this3.cc.prepareBroadcastState(stateFor, broadcastTriggeredBy || _constant.BROADCAST_TRIGGERED_BY_CC_INSTANCE_METHOD, module, state, true, lazyMs);
                  } else if (ccState.ccOption.syncSharedState) {
                    _this3.cc.prepareBroadcastState(stateFor, broadcastTriggeredBy || _constant.BROADCAST_TRIGGERED_BY_CC_INSTANCE_METHOD, module, state, false, lazyMs);
        ...
        _proto.$$domDispatch = function $$domDispatch(event) {
          ...
          var handler = this.__$$getDispatchHandler(_constant.STATE_FOR_ONE_CC_INSTANCE_FIRSTLY, module, reducerModule, type, payload, cclazyms);
        ...
        _proto.render = function render() {
          ...
          if (extendInputClass) {
            ...
            return _react.default.createElement(ReactClass, (0, _extends2.default)({}, this, this.props));
          }
        };
