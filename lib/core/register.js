...
var _ccContext$store = _ccContext.default.store,
    ...
    moduleName_sharedKeysWhichMapToGlobal_ = _ccContext.default.moduleName_sharedKeysWhichMapToGlobal_;
var cl = color;
var ss = styleStr;
var me = makeError;
var vbi = verboseInfo;
...
function checkSharedKeysAndGlobalKeys(ccClassKey, sharedStateKeys, globalStateKeys, globalMappingKey_sharedKey_) {
  ...
  if (hasGlobalMappingKey) {
    throw me(_constant.ERR.CC_CLASS_GLOBAL_STATE_KEYS_INCLUDE_SHARED_TO_GLOBAL_MAPPING_KEY, "ccClassKey " + ccClassKey + ", invalid global key " + matchedGlobalKey + ", matched state key " + matchedSharedKey);
  }
}
