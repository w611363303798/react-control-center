...
function canUserFnBeInvoked(module, currentModule, reactCallback, cb) {
  ...
  if (checkStoreModule(module, false)) {
    if (module != currentModule) {
      if (reactCallback) {
        handleError(me(_constant.ERR.CC_CLASS_INSTANCE_CALL_WITH_ARGS_INVALID, vbi(paramCallBackShouldNotSupply(module, currentModule))), false);
  ...
  return function (ReactClass) {
    ...
    function (_ReactClass) {
      ...
      function CcClass(props, context) {
        ...
        _util.default.bindThis((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), ['bindDataToCcClassContext', 'mapCcToInstance', 'broadcastState', 'changeState', 'changeStateWithExecutionContext', 'changeStateClosureExecutionContext', 'changeStateClosureReactCb', 'broadcastState', 'syncStateToOtherCcComponent']);
      ...
      _proto.changeStateWithExecutionContext = function changeStateWithExecutionContext(state, _ref7) {
        ...
        if (module === this.cc.ccState.module) {
          ...
          if (this.cc.ccState.ccOption.syncState) {
            ...
            this.broadcastState(module, _util.default.clone(state));
          }
        } else {
          this.broadcastState(module, _util.default.clone(state));
        }
