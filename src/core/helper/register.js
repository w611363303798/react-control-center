      ...
      const CcClass = class CcClass extends TargetClass {
        ...
        constructor(props, context) {
          try {
            ...
            util.bindThis(this, [
              '__$$mapCcToInstance', '__$$getChangeStateHandler', '$$changeState',
            ...
            const { ccUniqueKey, isCcUniqueKeyAutoGenerated } = helper.computeCcUniqueKey(isSingle, ccClassKey, ccKey);
            const ccClassContext = ccClassKey_ccClassContext_[ccClassKey];
            helper.setRef(this, isSingle, ccClassKey, ccKey, ccUniqueKey, ccOption);
