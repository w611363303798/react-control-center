  ...
  return function (ReactClass) {
    const CcClass = class extends ReactClass {
      ...
      bindDataToCcClassContext(ccClassKey, ccKey, ccUniqueKey, ccOption) {
        ...
        if (ccKeys.includes(ccUniqueKey)) {
          if (util.isHotReloadMode()) {
            if (getCcKeyInsCount(ccUniqueKey) > 2) {// cc now can make sure the ccKey duplicate
      ...
      mapCcToInstance(ccClassKey, ccKey, ccUniqueKey, isCcUniqueKeyAutoGenerated, ccOption, ccClassContext, currentModule, reducerModule, sharedStateKeys) {
        ...
        this.cc = {
          ccState: { renderCount: 0, ccClassKey, ccKey, ccUniqueKey, isCcUniqueKeyAutoGenerated, ccOption, ccClassContext, module: currentModule, reducerModule, sharedStateKeys },
          ccUniqueKey,
          ccKey,
          reactSetState: (state, cb) => {
            this.cc.ccState.renderCount += 1;
          ...
          callWith: (userLogicFn, { module = currentModule, forceSync = false, cb } = {}, ...args) => {
            ...
            checkStoreModule(module, false, () => {
              ...
              userLogicFn.call(this, this.changeStateClosureExecutionContext({ module, forceSync, targetCb }), ...args);
            });
          },
