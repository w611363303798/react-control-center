...
function checkSharedKeysAndGlobalKeys(module, ccClassKey, inputSharedStateKeys, inputGlobalStateKeys, globalMappingKey_sharedKey_, globalMappingKey_fromModule_) {
  ...
  let globalStateKeys = inputGlobalStateKeys;
...
export default function register(ccClassKey, {
  ...
  const { sharedStateKeys, globalStateKeys } = checkSharedKeysAndGlobalKeys(_curStateModule, ccClassKey, inputSharedStateKeys, inputGlobalStateKeys, globalMappingKey_sharedKey_, globalMappingKey_fromModule_);
