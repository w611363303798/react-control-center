...
export const ERR_MESSAGE = {
  ...
  [ERR.CC_CLASS_INSTANCE_KEY_NOT_FOUND]: 'ccKey must be supply to props while new a CCReactComponent!  ',
  ...
  [ERR.STORE_KEY_CC_FOUND]: 'key:"$$cc" is a built-in module name for react-controller-center,you can not configure it in you store! ',
